...
solve this problem, outperforming several simpler heuristics for
determining both the direction and extent of rotation.
...
(e.g., \cite{Pylyshyn1981}). In particular, Anderson
\cite{Anderson1978} proved that the mental imagery debate could not be
resolved on the basis of response time data alone. In recent years,
however, significant efforts have investigated the neural
underpinnings of the mental rotation phenomena, arguing that the
results of brain imaging studies support the existence of visual
imagery \cite{Kosslyn:2009tj,Kosslyn1988}.
...
against local maxima or incorrect rotation direction. The
