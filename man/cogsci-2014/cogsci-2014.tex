...
The average RT across all correctly-judged stimuli was \ExpTime{}
milliseconds; the full histogram of response times can be seen in
...
\cite<e.g.,>{Shepard1971,Cooper:1975wp}, our results are not as
perfectly linear.
...
however, the overall distribution of its response times did not match
that of people (Figure~\ref{fig:histograms}). Additionally, the \Th{}
model had 100\% accuracy, and thus did not exhibit a relationship
