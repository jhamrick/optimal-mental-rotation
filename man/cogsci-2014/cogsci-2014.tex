...
gained support across several areas of cognitive science
...
Equation~\ref{eq:lh-ratio}. We hypothesize a model based on the idea
...
Equation~\ref{eq:lh-ratio}:
$p(\ell)\approx\mathcal{N}(Z_0\ \vert\ \mathbb{E}[Z_0],
