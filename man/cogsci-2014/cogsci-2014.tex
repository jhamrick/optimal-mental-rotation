...
\begin{figure*}[t]
  \begin{center}
    ...
    \caption{\textbf{Response time histograms.} Each subplot shows a
      histogram of RTs for people (left) or one of the models (only
      for trials which were answered correctly).}
